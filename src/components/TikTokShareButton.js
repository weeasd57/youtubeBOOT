...
export default function TikTokShareButton({ videoUrl, videoTitle, multipleVideos = false }) {
  ...
  // Handle button click and prevent propagation
  ...
  const Modal = () => {
    return (
      <div 
        className="tiktok-share-modal"
        onClick={handleModalClick}
      >
        {/* Modal Content */}
        <div 
          ref={modalRef}
          className="tiktok-share-modal-content bg-white dark:bg-gray-900 rounded-lg shadow-xl max-w-md w-full"
        >
          {/* Modal Header */}
